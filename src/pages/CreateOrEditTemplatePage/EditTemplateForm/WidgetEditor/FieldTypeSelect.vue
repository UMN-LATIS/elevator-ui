  ...
  <div class="flex flex-col gap-1">
    ...
    <Listbox
      ...
      <Float
        ...
        <ListboxButton
          class="flex items-center gap-2 w-full rounded-md text-sm text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-primary px-3 py-2 hover:bg-surface-container-high transition-colors text-primary border border-outline-variant">
