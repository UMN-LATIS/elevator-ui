  ...
  <div>
    ...
    <div class="relative mt-1 rounded-md shadow-sm">
      ...
      <input
        ...
        :name="id"
        :value="value"
        class="block w-full rounded-md border-none focus:ring-indigo-500 focus:ring-offset-2 focus:ring-2 sm:text-sm py-2 bg-transparent-black-100 placeholder-transparent-black-400 px-4"
        :class="{
          'pl-10': $slots.prepend,
          'pr-10': $slots.append,
        }"
