<template>
  <div class="search-results-sort-select flex items-baseline gap-2">
    ...
    <select
      id="sort"
      name="sort"
      class="block w-full rounded-md border-0 py-2 pl-3 pr-10 text-on-surface ring-1 ring-inset ring-outline focus:ring-2 focus:ring-m3-primary text-sm sm:leading-6 max-w-full bg-transparent-white-800"
